...
- API version: 0.0.1
- Build date: 2021-06-19T13:00:53.503525Z[Etc/UTC]
...
cargo run --example client PostRoles
```
...
[**post_roles**](docs/default_api.md#post_roles) | **POST** /roles | post a new member
