    ...
    C: Has<XSpanIdString>  + Clone + Send + Sync + 'static,
{
    ...
    async fn get_assignments(
        &self,
        param_from: chrono::DateTime::<chrono::Utc>,
        param_to: chrono::DateTime::<chrono::Utc>,
        context: &C) -> Result<GetAssignmentsResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = serde_json::from_str::<Vec<models::Assignment>>(body)?;
                Ok(GetAssignmentsResponse::SuccessfulResponse
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetMembersResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::Member>>(body)?;
                Ok(GetMembersResponse::Status200
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetMembersMemberIdResponse, ApiError>
    {
        ...
        let mut uri = format!(
            ...
            self.base_path
            ,member_id=utf8_percent_encode(&param_member_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::Member>(body)?;
                Ok(GetMembersMemberIdResponse::Status200
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetRolesRoleIdResponse, ApiError>
    {
        ...
        let mut uri = format!(
            "{}/api/roles/{role_id}",
            self.base_path
            ,role_id=utf8_percent_encode(&param_role_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::Role>(body)?;
                Ok(GetRolesRoleIdResponse::SuccessfulResponse
                    (body)
                )
            }
            404 => {
                ...
                Ok(GetRolesRoleIdResponse::NotFound
                    (body)
                )
            }
            code => {
    ...
    async fn post_roles(
        &self,
        param_new_role: Option<models::NewRole>,
        context: &C) -> Result<PostRolesResponse, ApiError>
    {
        ...
        let body = param_new_role.map(|ref body| {
            serde_json::to_string(body).expect("impossible to fail to serialize")
        });
        ...
        match response.status().as_u16() {
            201 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::New>(body)?;
                Ok(PostRolesResponse::SuccessfulResponse
                    (body)
                )
            }
            code => {
